...
class TestDeleteTask:
    ...
    async def test_delete_task_missing_user_id(self):
        ...
        result = await delete_task(user_id=None, task_id=1)
    ...
    @pytest.mark.asyncio
    async def test_delete_task_whitespace_user_id(self):
    ...
    async def test_delete_task_missing_task_id(self):
        ...
        result = await delete_task(user_id="user_123", task_id=None)
